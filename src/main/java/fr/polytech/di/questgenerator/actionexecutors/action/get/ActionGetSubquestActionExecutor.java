...
public class ActionGetSubquestActionExecutor implements ActionExecutor
{
	...
	{
		return new Quest(new Action(depth, ActionType.GOTO), new Action(depth, ActionType.GET), new Action(depth, ActionType.GOTO), new Action(depth, ActionType.SUBQUEST), new Action(depth, ActionType.EXCHANGE, false));
	}
}
