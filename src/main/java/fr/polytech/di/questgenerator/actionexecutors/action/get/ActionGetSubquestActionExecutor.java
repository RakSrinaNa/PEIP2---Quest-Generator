...
public class ActionGetSubquestActionExecutor implements ActionExecutor
{
	...
	{
		return new Quest(new Action(depth, Actions.GOTO), new Action(depth, Actions.GET), new Action(depth, Actions.GOTO), new Action(depth, Actions.SUBQUEST), new Action(depth, Actions.EXCHANGE));
	}
}
