...
public class ActionGetSubquestActionExecutor implements ActionExecutor
{
	...
	{
		return new Quest(depth, new Action(depth, Actions.GOTO), new Action(depth, Actions.GET), new Action(depth, Actions.GOTO), new Action(depth, Actions.QUEST), new Action(depth, Actions.EXCHANGE));
	}
}
