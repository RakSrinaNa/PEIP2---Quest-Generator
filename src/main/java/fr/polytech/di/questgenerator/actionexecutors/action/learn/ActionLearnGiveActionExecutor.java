...
public class ActionLearnGiveActionExecutor implements ActionExecutor
{
	...
	{
		return new Quest(new Action(depth, ActionType.GET), new Action(depth, ActionType.SUBQUEST), new Action(depth, ActionType.GIVE, false), new Action(depth, ActionType.LISTEN, false));
	}
}
