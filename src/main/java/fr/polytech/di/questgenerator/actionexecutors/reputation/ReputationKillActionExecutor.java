...
public class ReputationKillActionExecutor implements ActionExecutor
{
	...
	{
		return new Quest(new Action(depth, ActionType.GOTO), new Action(depth, ActionType.KILL), new Action(depth, ActionType.GOTO), new Action(depth, ActionType.REPORT, false));
	}
}
