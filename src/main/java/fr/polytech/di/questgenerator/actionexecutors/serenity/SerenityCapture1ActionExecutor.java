...
public class SerenityCapture1ActionExecutor implements ActionExecutor
{
	...
	{
		return new Quest(new Action(depth, ActionType.GET), new Action(depth, ActionType.GOTO), new Action(depth, ActionType.USE, false), new Action(depth, ActionType.GOTO), new Action(depth, ActionType.GIVE));
	}
}
