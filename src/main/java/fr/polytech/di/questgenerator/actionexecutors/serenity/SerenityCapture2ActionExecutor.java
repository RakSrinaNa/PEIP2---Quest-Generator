...
public class SerenityCapture2ActionExecutor implements ActionExecutor
{
	...
	{
		return new Quest(depth, new Action(depth, Actions.GET), new Action(depth, Actions.GOTO), new Action(depth, Actions.USE), new Action(depth, Actions.CAPTURE), new Action(depth, Actions.GOTO), new Action(depth, Actions.GIVE));
	}
}
