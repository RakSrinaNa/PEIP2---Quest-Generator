...
public class SerenityCapture2ActionExecutor implements ActionExecutor
{
	...
	{
		return new Quest(new Action(depth, Actions.GET), new Action(depth, Actions.GOTO), new Action(depth, Actions.USE, false), new Action(depth, Actions.CAPTURE, false), new Action(depth, Actions.GOTO), new Action(depth, Actions.GIVE));
	}
}
