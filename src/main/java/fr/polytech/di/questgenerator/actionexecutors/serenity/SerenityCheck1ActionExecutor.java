...
public class SerenityCheck1ActionExecutor implements ActionExecutor
{
	...
	{
		return new Quest(new Action(depth, ActionType.GOTO), new Action(depth, ActionType.LISTEN, false), new Action(depth, ActionType.GOTO), new Action(depth, ActionType.REPORT, false));
	}
}
