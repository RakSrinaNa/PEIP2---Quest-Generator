...
public class SerenityCheck2ActionExecutor implements ActionExecutor
{
	...
	{
		return new Quest(new Action(depth, ActionType.GOTO), new Action(depth, ActionType.TAKE, false), new Action(depth, ActionType.GOTO), new Action(depth, ActionType.GIVE, false));
	}
}
