...
public class SerenityRescueActionExecutor implements ActionExecutor
{
	...
	{
		return new Quest(new Action(depth, Actions.GOTO), new Action(depth, Actions.DAMAGE, false), new Action(depth, Actions.ESCORT, false), new Action(depth, Actions.GOTO), new Action(depth, Actions.REPORT, false));
	}
}
