...
public class SerenityRescueActionExecutor implements ActionExecutor
{
	...
	{
		return new Quest(new Action(depth, ActionType.GOTO), new Action(depth, ActionType.DAMAGE, false), new Action(depth, ActionType.ESCORT, false), new Action(depth, ActionType.GOTO), new Action(depth, ActionType.REPORT, false));
	}
}
