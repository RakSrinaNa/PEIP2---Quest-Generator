...
public class WealthMakeActionExecutor implements ActionExecutor
{
	...
	{
		Action actionRepair = new Action(depth, ActionType.REPAIR, buildObjective(objectives, new ObjectiveHelper(OBJECTIVE, NONE, DataHandler.getRandomFromCategories("object/personal/*", "object/luxury/*"))), false);
